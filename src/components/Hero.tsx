      ...
      <div className="absolute inset-0 z-0">
        <div className="grid grid-cols-3 gap-4 p-8 h-full">
          ...
          <div className="space-y-4">
            <div className="h-1/2 relative overflow-hidden rounded-lg transform hover:scale-105 transition-transform duration-500 animate-float-slow">
              <img
            ...
            <div className="h-1/2 relative overflow-hidden rounded-lg transform hover:scale-105 transition-transform duration-500 animate-float-slower">
              <img
          ...
          {/* Center Column */}
          <div className="space-y-4">
            <div className="h-2/3 relative overflow-hidden rounded-lg transform hover:scale-105 transition-transform duration-500 animate-float">
              <img
            ...
            <div className="h-1/3 relative overflow-hidden rounded-lg transform hover:scale-105 transition-transform duration-500 animate-float-slow">
              <img
          ...
          {/* Last Column */}
          <div className="space-y-4">
            <div className="h-1/3 relative overflow-hidden rounded-lg transform hover:scale-105 transition-transform duration-500 animate-float-slower">
              <img
